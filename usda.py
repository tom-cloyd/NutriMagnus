"""
usda.py — USDA FoodData Central API client for numa.

API docs: https://fdc.nal.usda.gov/api-guide.html
Free API key signup: https://fdc.nal.usda.gov/api-key-signup.html

Key nutrient IDs used from USDA:
  1008 = Energy (kcal)
  1003 = Protein (g)
  1005 = Carbohydrate (g)
  1004 = Total fat (g)
  ...
  1404 = Omega-3 (g) [not always present]
  1087 = Calcium (mg)
  1089 = Iron (mg)
  1090 = Magnesium (mg)
  1091 = Phosphorus (mg)
  ...
  1176 = Biotin (mcg)
  1185 = Vitamin K2 (mcg) [not always present]
  -- Amino acids (for protein completeness) --
  1210 = Tryptophan (g)
  1211 = Threonine (g)
  1212 = Isoleucine (g)
  1213 = Leucine (g)
