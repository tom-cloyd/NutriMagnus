"""
test_demo_data.py — numa_app/services/demo_data.py: load/clear sample
foods/pantry/recipes, idempotency, and that real data is never touched.
"""
import pathlib
import sqlite3
...
def use_test_marker_file(tmp_path: pathlib.Path, monkeypatch: pytest.MonkeyPatch) -> None:
    """Redirect the demo-data marker file to a per-test temp path."""
