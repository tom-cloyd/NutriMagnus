...
_ALIASES: dict[str, str] = {
    ...
    "estimated":            "comp-estimate",
    "generic-estimate":     "comp-estimate",
    "comp-estimated":       "comp-estimate",
    "combinations":         "comb",
    "combination":          "comb",
    "two-step":             "comb",
    "dietary":              "diet",
    ...
    "capped":               "dcp-cap",
    "limiting":             "aa-scoring",
    "limiting-aa":          "aa-scoring",
    "limiting-amino-acid":  "aa-scoring",
    "aa-score":             "aa-scoring",
    "amino-acid-scoring":   "aa-scoring",
    "goal":                 "goals",
    "daily-goals":          "goals",
    ...
    # New table-specific topic aliases
    "glycemic-load":        "glycemic",
    "gl-output":            "glycemic",
    "nutrient-table":       "nutrients",
    "nutrients-table":      "nutrients",
    "protein-quality-table": "protein-quality",
    "aa-table":             "protein-quality",
    "meal-digestibility":   "meal-diaas",
    "digestibility-table":  "meal-diaas",
    "iaa":                  "iaa-ratios",
    "iaa-table":            "iaa-ratios",
    ...
    "search-results":       "food-search",
    "compare":              "food-comparison",
    "comparison":           "food-comparison",
    "import-review":        "food-import",
    "drafted":              "drafted-foods",
